...
export class ResConfig {
    ...
    // 武器
    public static arms_knife_list: ArmsConfig[] = [
        ...
        {name: '冷艳锯', physics_attack: 700, magic_attack: 0, has_blood: 250, has_magic: 50, arms_type: 'knife'},
        {name: '青龙偃月刀', physics_attack: 900, magic_attack: 0, has_blood: 250, has_magic: 50, arms_type: 'knife'},
        {name: '断魂血镰', physics_attack: 1100, magic_attack: 0, has_blood: 250, has_magic: 50, arms_type: 'knife'},
        {name: '皇龙偃月刀', physics_attack: 1300, magic_attack: 0, has_blood: 250, has_magic: 50, arms_type: 'knife'},
    ]

    // 武器
    public static arms_staff_list: ArmsConfig[] = [
        {name: '青玉镇邪杖', physics_attack: 0, magic_attack: 100, has_blood: 50, has_magic: 50, arms_type: 'staff'},
        {name: '灵山炼气杖', physics_attack: 0, magic_attack: 500, has_blood: 50, has_magic: 150, arms_type: 'staff'},
        {name: '玄天破邪杖', physics_attack: 0, magic_attack: 1000, has_blood: 50, has_magic: 250, arms_type: 'staff'},
    ]

    // 武器
    public static arms_stick_list: ArmsConfig[] = [
        ...
        {name: '侠少棍', physics_attack: 0, magic_attack: 500, has_blood: 250, has_magic: 250, arms_type: 'stick'},
        {name: '四平棍', physics_attack: 0, magic_attack: 600, has_blood: 250, has_magic: 250, arms_type: 'stick'},
        {name: '普度棍', physics_attack: 0, magic_attack: 700, has_blood: 250, has_magic: 250, arms_type: 'stick'},
        {name: '鹤舞棍', physics_attack: 0, magic_attack: 800, has_blood: 250, has_magic: 250, arms_type: 'stick'},
        {name: '分水棍', physics_attack: 0, magic_attack: 900, has_blood: 250, has_magic: 250, arms_type: 'stick'},
        {name: '潜龙棍', physics_attack: 0, magic_attack: 1000, has_blood: 250, has_magic: 250, arms_type: 'stick'},
        {name: '紫金梁', physics_attack: 0, magic_attack: 1100, has_blood: 250, has_magic: 250, arms_type: 'stick'},
        {name: '打狗棒', physics_attack: 0, magic_attack: 1200, has_blood: 250, has_magic: 250, arms_type: 'stick'},
        {name: '紧那罗棒', physics_attack: 0, magic_attack: 1300, has_blood: 250, has_magic: 250, arms_type: 'stick'},
        {name: '天蛇棍', physics_attack: 0, magic_attack: 1400, has_blood: 250, has_magic: 250, arms_type: 'stick'},
        {name: '青龙棍', physics_attack: 0, magic_attack: 1500, has_blood: 250, has_magic: 250, arms_type: 'stick'},
    ]

    // 衣服
    public static clothes_list: ClothesConfig[] = [
        {
            name: '守护之铠',
            blood_limit: 100,
            magic_limit: 100,
        ...
        },
        {
            ...
            physics_defense: 100,
            magic_defense: 500,
            has_physics_attack: 0,
            has_magic_attack: 200
        },
        {
            name: '龙麟铠甲',
            blood_limit: 500,
        ...
        },
        {
            ...
            physics_defense: 900,
            magic_defense: 300,
            has_physics_attack: 500,
            has_magic_attack: 1000
        },
    ]

    // 头盔
    public static helmet_list: HelmetConfig[] = [
        {
            name: '九耀御雷',
            blood_limit: 100,
            magic_limit: 100,
        ...
        },
        {
            ...
            physics_defense: 500,
            magic_defense: 600,
            has_physics_attack: 1500,
            has_magic_attack: 0
        },
    ]

    // 首饰
    public static jewelry_list: JewelryConfig[] = [
        {
            name: '碧血手镯',
            blood_limit: 100,
            magic_limit: 100,
    ...
    // 项链
    public static necklace_list: NecklaceConfig[] = [
        {
            name: '恶鬼',
            blood_limit: 100,
            magic_limit: 100,
    ...
    // 鞋子
    public static shoes_list: ShoesConfig[] = [
        {
            name: '辉煌圣靴',
            blood_limit: 100,
            magic_limit: 100,
    ...
    // 药品
    public static drug_list: DrugConfig[] = [
        {name: '止血草', blood: 100, magic: 100, effect_name: '', explain: ''},
        {name: '大补丸', blood: 200, magic: 100, effect_name: '', explain: ''},
        {name: '黑玉断续膏', blood: 200, magic: 200, effect_name: '', explain: ''},
        {name: '千年灵芝', blood: 400, magic: 400, effect_name: '', explain: ''},
        {name: '首阳参', blood: 500, magic: 500, effect_name: '', explain: ''},
        {name: '百草丹', blood: 600, magic: 600, effect_name: '', explain: ''},
        {name: '定魂丹', blood: 700, magic: 700, effect_name: '', explain: ''},
        {name: '大西瓜', blood: 800, magic: 800, effect_name: '', explain: ''},
        {name: '万年雪霜', blood: 1000, magic: 1000, effect_name: '', explain: ''},
        {name: '千年雪霜', blood: 2000, magic: 2000, effect_name: '', explain: ''},
        {name: '包子', blood: 3000, magic: 3000, effect_name: '', explain: ''},
        {name: '大包子', blood: 4000, magic: 4000, effect_name: '', explain: ''},
        {name: '金创药', blood: 5000, magic: 5000, effect_name: '', explain: ''},
        {name: '超级金创药', blood: 6000, magic: 6000, effect_name: '', explain: ''},
        {
            name: '灵引咒',
            blood: 0,
            magic: 0,
    ...
    // 技能书
    public static skillBook_list: SkillBookConfig[] = [
        {
            name: '烈火',
            blood: 0,
            magic: 0,
            consume_magic: 10,
            cd: 2,
            effect_name: 'RagingFire',
            explain: '烈火',
            arms_limit: "knife",
            effect_config: {name: '烈火', attack_l: 1, range_l: 1, type: 'attack'}
        },
        {
            name: '狂风斩',
            blood: 0,
            ...
            consume_magic: 20,
            cd: 2,
            effect_name: 'FierceWind',
            explain: '狂风斩',
            arms_limit: "knife",
            effect_config: {name: '狂风斩', attack_l: 3, range_l: 3, type: 'attack'}
        },
        {
            name: '逐日剑法',
            blood: 0,
            ...
            consume_magic: 50,
            cd: 2,
            effect_name: 'PursueSun',
            explain: '逐日剑法',
            arms_limit: "knife",
            effect_config: {name: '逐日剑法', attack_l: 4, range_l: 4, type: 'attack'}
        },
        {
            name: '冰咆哮',
            blood: 0,
            ...
            explain: '冰咆哮',
            arms_limit: "staff",
            effect_config: {name: '冰咆哮', attack_l: 13, range_l: 5, type: 'attack'}
        },
        {
            name: '流星火雨',
            blood: 0,
            ...
            consume_magic: 20,
            cd: 3,
            effect_name: 'MeteorSwarm',
            explain: '流星火雨',
            arms_limit: 'staff',
            effect_config: {name: '流星火雨', attack_l: 16, range_l: 6, type: 'attack'}
        },
        {
            name: '灭天火',
            blood: 0,
            ...
            explain: '灭天火',
            arms_limit: 'staff',
            effect_config: {name: '灭天火', attack_l: 19, range_l: 1, type: 'attack'}
        },
        {
            name: '噬血术',
            blood: 0,
            ...
            consume_magic: 10,
            cd: 4,
            effect_name: 'Hemophagy',
            explain: '噬血术',
            arms_limit: 'stick',
            effect_config: {name: '噬血术', attack_l: 19, range_l: 1, type: 'attack'}
        },
        {
            name: '治愈术',
            blood: 0,
            ...
            effect_config: {
                ...
                type: 'assist',
                continue_time: 100,
                add_continue_blood: 20,
                add_continue_magic: 0
            }
        },
        {
            name: '灵引符',
    ...
    // 怪物
    public static monster_list: PetConfig[] = [
        {
            name: '抓猫',
            blood: 100,
            magic: 100,
